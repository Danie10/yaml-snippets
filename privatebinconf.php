...
name = "GadgeteerZA PrivateBin"

; The full URL, with the domain name and directories that point to the
; PrivateBin files, including an ending slash (/). This URL is essential to
; allow Opengraph images to be displayed on social networks.
basepath = "https://privatebin.gadgeteer.co.za/"
...
; prettify, sons-of-obsidian, doxy, desert, or sunburst
...
notice = "Note: DNS via Cloudflare: Data may be deleted anytime. Kittens will die if you abuse this service."
...
signature = "yoursighere"
; (optional) the URL of the YOURLS API, called to shorten a PrivateBin URL
; apiurl = "https://yourls.example.com/yourls-api.php"
apiurl = "https://links.gadgeteer.co.za/yourls-api.php"
